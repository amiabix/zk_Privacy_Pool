...
fn main() {
    ...
    let batch: SimplePoolBatch = bincode::deserialize(&input)
    ...
    for transaction in &batch.transactions {
        ...
        if is_valid {
            ...
            match transaction.tx_type.as_str() {
                ...
                _ => {
                    // Unknown transaction type - transaction fails
                    successful_txs -= 1;
                    total_fees -= fee;
                }
            }
...
fn compute_batch_hash(batch: &SimplePoolBatch) -> [u8; 32] {
    ...
    for transaction in &batch.transactions {
        ...
        hasher.update(transaction.tx_type.as_bytes());
    }
