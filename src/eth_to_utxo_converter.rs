...
use crate::utxo_indexing::{IndexedUTXO, UTXOId};
use crate::merkle_tree::MerkleTree;
use crate::real_blockchain_integration::{RealBlockchainClient, RealDepositEvent, BlockchainConfig};
...
impl ETHToUTXOConverter {
    ...
    fn add_secure_utxo_to_tree(&mut self, utxo: &IndexedUTXO) -> Result<Nullifier> {
        ...
        let utxo_for_tree = crate::utxo::UTXO::new(
            utxo.value,
            utxo.blinding_factor,
            nullifier.0, // Use our generated nullifier
            [0u8; 32], // Owner would be derived from public key
        );
        
        self.merkle_tree.insert_utxo(utxo_for_tree)
