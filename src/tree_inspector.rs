...
use crate::real_blockchain_integration::BlockchainConfig;
...
impl TreeInspector {
    ...
    fn perform_security_analysis(&self, utxos: &[&crate::utxo_indexing::IndexedUTXO]) -> Result<()> {
        println!("\n🔐 Security Analysis:");
        println!("{}", "-".repeat(50));
    ...
    fn perform_privacy_analysis(&self, utxos: &[&crate::utxo_indexing::IndexedUTXO]) -> Result<()> {
        println!("\n🔒 Privacy Analysis:");
        println!("{}", "-".repeat(50));
    ...
    fn visualize_secure_tree_structure(&self, utxos: &[&crate::utxo_indexing::IndexedUTXO]) -> Result<()> {
